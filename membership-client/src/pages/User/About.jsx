      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-6 py-16 md:py-24">
        <header className="mb-20 text-center">
          ...
          <p className="text-zinc-500 font-medium max-w-2xl mx-auto text-sm">
            We offer specialized memberships tailored to foster connection,
            heritage, and growth within the Ethiopian Diaspora in the GTA.
            ...
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <div className="flex items-center gap-3 justify-center md:justify-start">
                ...
                <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest">
                  Ethiopian Community around GTA
                </span>
              </div>
            </div>
          </section>
